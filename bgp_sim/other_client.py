...
for root in root_list:
    for size in ['L','M','S']:
        for i in range(10):
            ...
            os.system('mono TestingApplication/bin/Debug/TestingApplication.exe -server11000 Cyclops_caida_cons.txt US-precomp367.txt exit_asns.txt > result_%d_%s_%s.txt &' % (i, size, root))
            os.system('sleep 5s')
