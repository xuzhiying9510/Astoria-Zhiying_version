    ...
    for i in range(10):
        ...
        for size2 in ['L','M','S']:
            ...
            for i2 in index_list:
                ...
                os.system('mono TestingApplication/bin/Debug/TestingApplication.exe -server11000 Cyclops_caida_cons.txt US-precomp367.txt exit_asns.txt > result_%d_%s_%d_%s_1.txt &' % (i, size, i2, size2))
                os.system('sleep 5s')
